...
class TobasCorpus(Corpus):

     # def __init__(self, vocabulary):
     #
     #     self.vocabulary = vocabulary  # This must be a list or an object with a .items() message
    def __init__(self, tweets, min_absolute_freq=10, max_relative_freq=0.4, separator='\t', save_voc=False):
        ...
        if self.tweets:
            ...
            for word, frequency in vocabulary:
                if frequency > min_absolute_freq and float(frequency / self.size) < max_relative_freq:
        ...
        for line in self.tweets:
            ...
            for word in set(words):
                ...
                if word_id is not None:
                    ...
                    #GAB if mention:
                    #GAB    self.mention_freq[word_id, time_slice] += 1
